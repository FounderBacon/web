...
// Stats principales pour les traps
const BASIC_STATS = ["damage", "dps", "armTime", "fireDelay", "reloadTime", "durability"] as const
const COMBAT_STATS = ["impactDamage", "envDamage", "knockback", "stunTime", "stunScale"] as const
const DURABILITY_STATS = ["durability", "durabilityPerUse", "totalActivations"] as const

export function TrapStatsColumn({ baseStats, modifiedStats, loading }: TrapStatsColumnProps) {
  ...
  const groups: { id: string; title: string; stats: readonly string[] }[] = [
    { id: "basic", title: "Basic", stats: BASIC_STATS },
                  ...
                  <AccordionContent>
                    <div className="mb-3">
                      <div className="flex items-baseline gap-2">
                        ...
                        {hasPerks && typeof modifiedStats.avgDps === "number" && typeof baseStats.avgDps === "number" && Math.abs(modifiedStats.avgDps - baseStats.avgDps) > 0.01 && (
