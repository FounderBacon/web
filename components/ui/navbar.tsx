...
export function Navbar({ locale, dict }: NavbarProps) {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full">
      <div className="flex items-center justify-between bg-king-900 dark:bg-king-800 px-4 py-4 md:px-10">
      ...
      {open && (
        <div className="flex flex-col gap-4 bg-king-900 dark:bg-king-800 px-4 pb-6 md:hidden">
      ...
      <BgNavbar className="block w-full h-auto text-king-900 dark:text-king-800" fill="currentColor" />
    </nav>
  )
}
